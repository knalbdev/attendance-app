...
class StorageServices {
  ...
  final DatabaseReference _database = FirebaseDatabase.instanceFor(
    ...
    databaseURL: 'https://attendance-app-66b1c-default-rtdb.asia-southeast1.firebasedatabase.app/',
  ).ref();

  // upload photo to firebase raltime database as Base64 (string)
  Future<String> uploadAttendancePhoto(String localPath, String photoType) async {
    try {
      ...
      // compress image to reduce size (importnat for realtime database)
